...
const SidebarItem = ({
    ...
    return (
        ...
        `}
            ...
            {expandable && expanded && children && <div className="mt-1 ml-8">{children}</div>}
        </div>
    );
};
    ...
    return (
        <div className="flex h-screen w-64 flex-col bg-[#121212] shadow-blue-500/10 shadow-lg">
            ...
            <div className="p-4">
                ...
                <Link
                    to="/file-upload"
                    className="mb-6 flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-2 text-white shadow-md transition-all hover:opacity-90"
                >
            ...
            <div className="flex-1 overflow-y-auto px-4 py-2">
                ...
                <SidebarItem icon={LinkIcon} label="Manage Your Links" path="managed-links" />

                <SidebarItem icon={FolderIcon} label="My Files" path="my-files" />
