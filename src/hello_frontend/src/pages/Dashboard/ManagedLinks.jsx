...
const initialLinks = [
    {
        ...
        folder: "Marketing",
        url: "https://example.com/share/marketing",
        accessed: 24,
        created: "2023-10-15",
        expires: "2024-10-15",
    },
    {
        ...
        name: "Design Files",
        folder: "Design",
        url: "https://example.com/share/design",
        accessed: 12,
        created: "2023-11-10",
        expires: "2024-11-10",
    },
    {
        ...
        folder: "Development",
        url: "https://example.com/share/dev",
        accessed: 56,
        created: "2023-09-05",
        expires: "2024-09-05",
    },
        ...
        <Layout>
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="tabs">
                    ...
                    <label htmlFor="links-tab" className="tab">
                        Shared Links
                    </label>

                    <input type="radio" name="tabs" id="tokens-tab" className="tab" />
                    <label htmlFor="tokens-tab" className="tab">
                        Access Tokens
                    </label>
                                ...
                                <tbody>
                                    {tokens.map((token) => (
                                        <tr key={token.id}>
                                            ...
                                            <td>
                                                <span
                                                    className={`badge ${token.active ? "badge-success" : "badge-error"}`}
                                                >
